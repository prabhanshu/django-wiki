...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'URLPath.slug'
        db.alter_column('wiki_urlpath', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=250, null=True, blank=True))

    def backwards(self, orm):

        # Changing field 'URLPath.slug'
        db.alter_column('wiki_urlpath', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50, null=True, blank=True))
